...
parser.add_argument('--output_dir', dest='output_dir', type=str, default='/home/joe/git/visual_genome/im2p', help='output directory of data files')
parser.add_argument('--limit_ram', dest='limit_ram', action='store_true')
parser.add_argument('--max_words', dest='max_words', type=int, default=20, help='maximum length of words for training.')
...
VG_PARA_PATH = '../data/paragraphs_v1.json'
...
SPLITS_PATH = cfg.ROOT_DIR + '/data/%s_split.json'
